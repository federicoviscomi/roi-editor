        ...
        return (
            <div className={classes.container}>
                ...
                <div className={classes.usage}>
                    ...
                    <p>You should provide your objects and object types. The objects might be empty array if you want to
                        create a
                        blank canvas.</p>
          ...
          `.trim()}</pre>
                ...
                <div className={classes.example}>
                    <div className={classes.info}>
                        ...
                        <p>
                            <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/Mondrian.js">Show
                                example on github</a>
                        </p>
                    </div>
                ...
                <div className={classes.example}>
                    <div className={classes.info}>
                        ...
                        <p>
                            <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/Malevich.js">Show
                                example on github</a>
                        </p>
                    </div>
                    <div className={classes.preview}>
                ...
                <div className={classes.example}>
                    <div className={classes.info}>
                        ...
                        <p>Default configuration with initial text and shapes with blending modes on the internal state
                            of
                            container component.</p>

                        <p>
                            <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/SwissStyle.js">Show
                                example on github</a>
                        </p>
                    </div>
                    <div className={classes.preview}>
                ...
                <div className={classes.example}>
                    <div className={classes.info}>
                        ...
                        <ul>
                            <li><a
                                href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/MockupDesigner.js#L32">Button</a>
                            </li>
                            <li><a
                                href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/MockupDesigner.js#L73">Input</a>
                            </li>
                            <li><a
                                href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/MockupDesigner.js#L7">H1</a>
                            </li>
                            <li><a
                                href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/MockupDesigner.js#L19">Link</a>
                            </li>
                            <li><a
                                href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/MockupDesigner.js#L113">Fieldset</a>
                            </li>
                        </ul>
                        ...
                        <p>
                            <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/MockupDesigner.js">Show
                                example on github</a>
                        </p>
                    </div>
                    <div className={classes.preview}>
                ...
                <div className={classes.example}>
                    <div className={classes.info}>
                        ...
                        <p>Price calculation is a simple pure function that receives object list and returns total
                            price.</p>
                        ...
                        <p>
                            <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/TshirtDesigner.js">Show
